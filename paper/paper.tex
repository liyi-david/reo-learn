...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=.4\textwidth]{./images/activelearning.png}
  \end{center}
  \caption{Active Automata Learning}
  \label{fig:activelearning}
\end{figure}

Figure \ref{fig:activelearning} shows a sketch of active learning, wherein:
\begin{itemize}
  \item[-]
\end{itemize}

More details on the algorithm will be presented in Section \ref{sec:activelearning}. 
