...
hypothetical Mealy machines in learning algorithm L*.

As mentioned before, Mealy machines consist of \emph{states} and \emph{transitions}. However in
blackboxes, we only have \emph{input sequences} and their corresponding \emph{outputs}.
Similarly, for all $a\in\mathcal{I}$, we use $sa$ to denote the successor
