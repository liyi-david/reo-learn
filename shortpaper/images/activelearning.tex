...
text centered, minimum height=1em,drop shadow, font=\small]
\tikzstyle{ann} = [above, text width=3em, text centered, font=\small]
\tikzstyle{wa} = [sensor, text width=4em, fill=red!20, 
minimum height=4em, rounded corners, drop shadow, font=\small]
\tikzstyle{sc} = [sensor, text width=5em, fill=red!20, 
minimum height=4em, rounded corners, drop shadow, font=\small]
...
\begin{tikzpicture}[scale=0.7]
    ...
    \path [draw, ->] (wa.east) -- node [above] {} 
        ...
        \path (wa.south) +(0,-\blockdist) node (asrs) {System Under Learn - SUT};
